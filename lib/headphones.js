...
class HeadphonesCheck {
            ...
            if (--audioCount <= 0) {
              $('button[data-headphones-audio-control]')
                  ...
                  .on('click', function() {
                    ...
                    console.log('audio[data-headphones-audio-group=' + this.dataset.headphonesAudioGroup + ']');
                    console.log($('audio[data-headphones-audio-group]'));
                    audioElements.each((i, audio) => {
                      audio.volume = audio.dataset.headphonesVolume;
    ...
    _createDialog(options = {}) {
      ...
      return new Promise((resolve, reject) => {
        ...
        $(this._settings.parentElement).append('<div id="headphones-dialog" title="' + options.title + '">' + options.content + '</div>');
        ...
        dialog.css("position", "relative"); // TODO this is a hack so we can see it at all; there is more to be done to make it look nice, perhaps avoiding the "ui dialog" thing entirely
