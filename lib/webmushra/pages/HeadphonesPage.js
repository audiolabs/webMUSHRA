...
HeadphonesPage.prototype.render = function (_parent) {
    const pageTemplateRenderer = this.pageTemplateRenderer; // needed because "this" in showResult will be something else
    ...
    function showResult(result) {
        ...
        if (result) {
            ...
            $('#testResults').append('<p>Sorry, you must pass the headphones check to continue. Please contact the researcher to help troubleshoot your set up.</p>')
        }
    }
