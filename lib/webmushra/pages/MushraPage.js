...
MushraPage.prototype.renderCanvas = function (_parentId) {
  ...
  canvasContext.fillText(this.pageManager.getLocalizer().getFragment(this.language, 'excellent'), xLetters, prevScalesHeight * 0.0 + YfirstLine);
  canvasContext.fillText(this.pageManager.getLocalizer().getFragment(this.language, 'good'), xLetters, prevScalesHeight * 0.25 + YfirstLine);
  ...
  canvasContext.fillText(this.pageManager.getLocalizer().getFragment(this.language, 'poor'), xLetters, prevScalesHeight * 0.75 + YfirstLine);
  canvasContext.fillText(this.pageManager.getLocalizer().getFragment(this.language, 'bad'), xLetters, prevScalesHeight * 1.0 + YfirstLine);
  ...
  canvasContext.fillText("+2", xTextScoreRanges, YfirstLine);
  canvasContext.fillText("+1", xTextScoreRanges, prevScalesHeight * 0.25 + YfirstLine);
  canvasContext.fillText("0", xTextScoreRanges, prevScalesHeight * 0.5 + YfirstLine);
  canvasContext.fillText("-1", xTextScoreRanges, prevScalesHeight * 0.75 + YfirstLine);
  canvasContext.fillText("-2", xTextScoreRanges, prevScalesHeight * 1 + YfirstLine);
