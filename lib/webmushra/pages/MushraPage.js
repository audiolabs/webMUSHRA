...
MushraPage.prototype.render = function (_parent) {
  ...
  for (i = 0; i < conditions.length; ++i) {
    td = $("<td class='spaceForSlider'> \
      <span><input type='range' name='"+ conditions[i].getId() + "' class='scales' value='0' min='-3' max='3' data-vertical='true' data-highlight='true' style='display : inline-block; float : none;'/></span> \
    </td>");
...
MushraPage.prototype.renderCanvas = function (_parentId) {
  ...
  canvasContext.font = "1.00em BBC Reith Sans";
  ...
  canvasContext.fillText(this.pageManager.getLocalizer().getFragment(this.language, 'vvgood'), xLetters, prevScalesHeight * 0.0 + YfirstLine);
  canvasContext.fillText(this.pageManager.getLocalizer().getFragment(this.language, 'vgood'), xLetters, prevScalesHeight * 0.17+ YfirstLine);
  canvasContext.fillText(this.pageManager.getLocalizer().getFragment(this.language, 'good'), xLetters, prevScalesHeight * 0.33+ YfirstLine);
  canvasContext.fillText(this.pageManager.getLocalizer().getFragment(this.language, 'same'), xLetters, prevScalesHeight * 0.5 +YfirstLine);
  canvasContext.fillText(this.pageManager.getLocalizer().getFragment(this.language, 'bad'), xLetters, prevScalesHeight * 0.66 + YfirstLine);
  canvasContext.fillText(this.pageManager.getLocalizer().getFragment(this.language, 'vbad'), xLetters, prevScalesHeight * 0.83 + YfirstLine);
  canvasContext.fillText(this.pageManager.getLocalizer().getFragment(this.language, 'vvbad'), xLetters, prevScalesHeight * 1.0 + YfirstLine);


  canvasContext.font = "1em BBC Reith Sans";
  canvasContext.textAlign = "Right";
  var xTextScoreRanges = xDrawingStart - canvasContext.measureText("100 ").width * 0.25; // $("#refCanvas").width()
  canvasContext.fillText("+3", xTextScoreRanges, YfirstLine);
  canvasContext.fillText("+2", xTextScoreRanges, prevScalesHeight * 0.17 + YfirstLine);
  canvasContext.fillText("+1", xTextScoreRanges, prevScalesHeight * 0.33 + YfirstLine);
  canvasContext.fillText("0", xTextScoreRanges, prevScalesHeight * 0.5 + YfirstLine);
  canvasContext.fillText("-1", xTextScoreRanges, prevScalesHeight * 0.66 + YfirstLine);
  canvasContext.fillText("-2", xTextScoreRanges, prevScalesHeight * 0.83 + YfirstLine);
  canvasContext.fillText("-3", xTextScoreRanges, prevScalesHeight * 1 + YfirstLine);
