...
PreferenceTestPage.prototype.render = function (_parent) {
  ...
  var radioChoice = $("<div id='radio-choice' data-role='controlgroup' data-type='horizontal'>\
    <input type='radio' name='radio-choice' id='radio-choice-a' value='a' disabled>\
    <label for='radio-choice-a' disabled>A</label>\
    <input type='radio' name='radio-choice' id='radio-choice-b' value='b' disabled>\
    <label for='radio-choice-b' disabled>B</label>\
  </div>");
